...
class AddTreeReplacementPass(OpTreeReplacementPass):
    add_node_specs = [('call_function', (torch.add, operator.add, operator.iadd)),
                      ('call_method', ('add',))]
...
class MasksoftmaxReplacementPass(SequentialPass):
    def __init__(self, masksoftmax, symbolic_trace):
        # the symbolic_trace should be masksoftmax leaftracer
